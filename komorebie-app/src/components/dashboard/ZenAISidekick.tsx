  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between relative z-10">
        <div className="flex items-center gap-2 text-[11px] uppercase tracking-[0.2em] text-white/50 font-bold">
          <Brain className="w-4 h-4 text-sage-200" />
          Zen Sidekick
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-1.5 h-1.5 rounded-full bg-sage-200 animate-pulse shadow-[0_0_8px_rgba(183,201,176,0.5)]" />
          <span className="text-[10px] uppercase tracking-widest text-sage-200 font-bold">Active</span>
        </div>
      </div>

      <div className="space-y-5 relative z-10">
        <div className="space-y-2">
          <div className="text-[11px] text-white/60 font-medium tracking-wide">Current Insight</div>
          <div className="p-4 bg-white/5 border border-white/5 rounded-2xl group/insight hover:border-sage-200/20 transition-all cursor-pointer">
            <p className="text-[12px] leading-relaxed text-white/90 font-light italic">
        ...
        <div className="space-y-3">
          <div className="text-[11px] text-white/60 font-medium tracking-wide">Quick Actions</div>
          <div className="space-y-2">
            <button className="w-full p-3 bg-sage-200/10 hover:bg-sage-200/20 border border-sage-200/10 rounded-xl flex items-center justify-between group/action transition-all cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[11px] text-white/80 font-medium">Generate Flashcards</span>
              </div>
            ...
            <button className="w-full p-3 bg-white/5 hover:bg-white/10 border border-white/5 rounded-xl flex items-center justify-between group/action transition-all cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[11px] text-white/80 font-medium">Clarify Last Session</span>
              </div>
              <ArrowRight className="w-3 h-3 text-white/20 group-hover/action:translate-x-1 transition-transform" />
            </button>
          </div>
      ...
      <div className="mt-auto pt-4 flex items-center justify-between border-t border-white/5 relative z-10">
        <div className="text-[10px] text-white/40 font-bold uppercase tracking-widest">Awaiting Input</div>
