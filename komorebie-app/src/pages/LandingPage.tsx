      ...
      <div className="relative min-h-screen z-10">
        <section className="flex flex-col items-center justify-center min-h-screen text-center px-4 pt-20">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <h1 className="text-6xl md:text-8xl font-display font-light mb-6 tracking-tight">
              Focus like <span className="text-sage-200">sunlight</span> <br />
              through trees.
            </h1>
            <p className="text-xl md:text-2xl text-white/60 font-light mb-12 max-w-2xl mx-auto">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative px-8 py-4 bg-sage-200 text-slate-950 rounded-full font-display font-medium text-lg flex items-center gap-2 overflow-hidden mx-auto cursor-pointer pointer-events-auto"
            >
        ...
        <section className="px-4 py-32 text-center pb-64">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-display font-light mb-8 italic">"The breath between tasks."</h2>
